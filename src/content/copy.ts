...
const en = {
  ...
  journey: { eyebrow: "Interactive route map", title: "See how the product fits together.", description: "Choose a journey, then open any screen to see its purpose, key actions, and engineering decisions.", select: "Select a screen", actions: "What you can do", engineering: "Under the hood", related: "Connected screens", loading: "Loading screenshot…", imageError: "Screenshot unavailable" },
  ...
  footer: { title: "Built for sellers who would rather focus on their table.", description: "GoodsBar is available for iPad on the App Store. This showcase uses demonstration data; screens and capabilities may evolve.", github: "GitHub profile", notice: "© 2026 NekoWings · Product showcase" },
} satisfies SiteCopy;

const zh = {
  nav: { journey: "产品路径", features: "功能", engineering: "工程", resume: "简历", roadmap: "状态" },
  hero: { eyebrow: "离线优先的 iPad POS", title: "让同人展售卖井然有序。", description: "GoodsBar 为独立摊主提供制品、库存、结算、拣货与复盘一体化工作台。", explore: "探索产品", appStore: "前往 App Store 下载", source: "在 GitHub 查看", notice: "独立产品 · 已在 iPad App Store 上线" },
  ...
  journey: { eyebrow: "交互式路由图", title: "了解产品如何连接起来。", description: "选择一个使用阶段，再打开任意页面，查看它的目标、主要操作与工程实现。", select: "选择一个页面", actions: "可以完成", engineering: "工程实现", related: "关联页面", loading: "正在加载截图…", imageError: "截图暂时无法显示" },
  ...
  footer: { title: "把注意力留给摊位和客人。", description: "GoodsBar 已在 App Store 上线，支持 iPad。本展示站使用演示数据，界面与功能可能继续演进。", github: "GitHub 主页", notice: "© 2026 NekoWings · 产品展示" },
} satisfies SiteCopy;
